...
def test():
    """Prueba que el bot envíe un mensaje a Telegram."""
    resultado = send_telegram("✅ <b>Bot funcionando!</b>\n\nEl servidor de Portal Recargas está conectado correctamente a Telegram.")
    if resultado and resultado.get("ok"):
        return jsonify({"status": "ok", "mensaje": "Mensaje enviado a Telegram!"}), 200
    else:
        return jsonify({"status": "error", "detalle": resultado}), 500
